...
When settling with this theme, you should know more about 
configuring stuff. 
...
Here's a 
https://foo-dogsquared.github.io/hugo-theme-terminal-plus-minus-demo/articles/asciidoctor-syntax-guide/[demo] 
of the theme. 
